...
#define BULLET_COOLDOWN_SECONDS 0.12f
...
#define RECYCLE_STATIC_RESTORE_DELAY (60 * 15)
#define RECYCLE_OWNED_STATIC_MAX_FRAMES (60 * 30)
...
// KD-stats constants
#define VOXEL_DAMAGE 34
#define MATTER_MAX_DEFAULT 100.0f
#define MATTER_MELEE_HARVEST 25.0f
